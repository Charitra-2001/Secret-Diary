    ...
    if(array_key_exists("logout",$_GET)=='1')
      ...
      else if((array_key_exists("id",$_SESSION)&&$_SESSION['id'])||(array_key_exists("id",$_COOKIE)&&$_COOKIE['id']))
      {
        ...
        if(isset($_POST['Username'])!=''&&$_POST['Password']!='')
        {
          ...
          {
             $query="INSERT INTO `users`(`email`,`password`,`information`) VALUES ('".mysqli_real_escape_string($link,$_POST['Username'])."','".mysqli_real_escape_string($link,$_POST['Password'])."','Start writing your diary!(remove this text)')";
...
<html lang="en">
  ...
  <body class="img-responsive">
      <div class="container" style="text-align:center">
          ...
          <h1 class="design">Secret Diary</h1>
          <h5 class="design">Store your thoughts permanently and securely</h5>
          ...
          <p></p>
          <a href="sign_in.php"class="mylogin"><strong>Log in</strong></a>
